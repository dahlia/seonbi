...
spec = do
    ...
    specify "phoneticizeHanja" $ do
        normalizeText (phoneticizeHanja phoneticizeHanjaWord inputFixture)
            `shouldBe` normalizeText outputFixture
        normalizeText (phoneticizeHanja phoneticizeHanjaWordWithInitialSoundLaw
                                        inputFixture)
            `shouldBe` normalizeText outputWithInitialSoundLawFixture
